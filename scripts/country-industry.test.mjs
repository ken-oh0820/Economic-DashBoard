...
test('browser assets are versioned consistently and collection remains official WDI only',()=>{
  ...
  for(const asset of ['country-profile.mjs','country-profile.css'])assert.ok(html.includes(`${asset}?v=20260923-us-geography1`));
  assert.ok(html.includes('country-data-client.mjs?v=20260922-registry1'));
