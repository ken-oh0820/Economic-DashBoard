...
test('browser assets are versioned consistently and collection remains official WDI only',()=>{
  ...
  for(const asset of ['country-profile.mjs','country-data-client.mjs','country-profile.css'])assert.ok(html.includes(`${asset}?v=20260921-industry1`));
  for(const file of ['../assets/country-profile.mjs','../assets/country-data-client.mjs','../assets/country-industry.mjs'])assert.match(read(file),/country-data.mjs\?v=20260921-industry1/);
